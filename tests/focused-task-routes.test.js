...
test("a treatment group, add-on, or location create or edit route is focused", () => {
...
test("a treatments route, a list route, or a non-matching route is not focused", () => {
  assert.equal(isFocusedTaskRoute("/dashboard/treatments/new"), false);
  assert.equal(isFocusedTaskRoute("/dashboard/treatments/abc123/edit"), false);
