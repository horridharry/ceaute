...
`buildStripeRefundRequest` already sends once the fee is non-zero, is the right
combination and is kept. Stripe never returns its processing fee on a refund,
