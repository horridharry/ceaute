...
export default function DashboardUI({ user, profile }) {
  return (
    <main className="container max-w-md p-5">
      <div className="mt-6 flex flex-col">
        <h1 className="text-3xl font-bold tracking-tighter">Dashboard</h1>
        <p className="text-sm mt-1">
          Manage everything to do with your fleekd account
        </p>
        ...
        {profile.username ? (
          <span className="mt-6">
            <div className="rounded-xl border p-3">
              ...
              <p className="mt-1 text-sm">{`fleekd.com/${profile?.username}`}</p>
            </div>
            <div className="flex items-center justify-end gap-2.5 mt-2">
              ...
              <button
                onClick={() => {
                  return copy(`fleekd.com/${profile.username}`);
                }}
          ...
          <span className="mt-6">
            <div className="rounded-xl border p-3">
              ...
              <Link href={`/provider/profile`} className="">
