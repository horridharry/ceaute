    ...
    >
      ...
      >
        ...
        <button
          ...
          className="mt-6 w-full rounded-lg bg-accent-700 p-3 text-sm font-semibold text-white shadow-sm duration-200 hover:bg-accent-700 disabled:cursor-not-allowed disabled:opacity-60"
        >
