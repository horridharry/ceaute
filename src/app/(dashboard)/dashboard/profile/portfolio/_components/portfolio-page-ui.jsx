  ...
  return (
    <form className="mt-3 flex flex-col gap-2" action={updateAction}>
      ...
      <button
        ...
        className="w-max rounded-lg border border-black/10 p-2 px-4 text-sm font-semibold text-accent-600 duration-200 hover:border-black/20 disabled:cursor-not-allowed disabled:opacity-60"
      >
  ...
  return (
    <form action={formAction}>
      ...
      <button
        ...
        className="rounded-lg border border-black/10 p-2 px-3 text-sm font-semibold text-accent-600 duration-200 hover:border-black/20 disabled:cursor-not-allowed disabled:opacity-60"
      >
        {pending ? "..." : children}
      </button>
    </form>
